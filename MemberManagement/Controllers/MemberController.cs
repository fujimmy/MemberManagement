...
namespace MemberManagement.Controllers
{
    public class MemberController : Controller
    {
        ...
        {
            ViewBag.Message = "Member Management System";
            return View();
        }
		...
		{
			//ref:https://blog.hungwin.com.tw/aspnet-mvc-member-register/
			...
			else
			{
				...
				try
				{
					...
					else
					{
						...
						byte[] bytes = System.Text.Encoding.UTF8.GetBytes(salt + inModel.UserPwd); //將密碼鹽及原密碼組合
